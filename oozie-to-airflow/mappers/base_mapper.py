...
class BaseMapper:
    ...
    def convert_tasks_and_relations(self) -> Tuple[List["primitives.Task"], List["primitives.Relation"]]:
        """
        Convert a tasks and relations.
        """
    ...
    def first_task_id(self) -> str:
        ...
        """
        tasks, relations = self.convert_tasks_and_relations()
